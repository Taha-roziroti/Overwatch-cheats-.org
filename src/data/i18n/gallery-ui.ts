...
export const galleryUi: Record<LocaleCode, GalleryUi> = {
	en: {
		...
		lead: 'Destiny 2 Cheats helps you spot Guardians, enemies, loot, and extracts with ESP, aimbot, and radar in one license.',
		highlights: [
			{ title: 'Destiny 2 cheats esp', copy: 'See players through walls with Destiny 2 cheats esp and wallhack overlays.' },
			{ title: 'Destiny 2 cheats radar', copy: 'Track nearby threats with Destiny 2 cheats radar before you push or extract.' },
	...
	es: {
		...
		lead: 'Destiny 2 Cheats está pensado para el loop BR de Destiny 2: leer el mapa, rastrear escuadrones enemigos, lootear y sobrevivir al extract.',
		highlights: [
	...
	fr: {
		...
		lead: 'Destiny 2 Cheats suit la boucle BR de Destiny 2 : lire la carte, suivre les escouades, loot et survivre au extract.',
		highlights: [
	...
	pt: {
		...
		lead: 'Destiny 2 Cheats segue o loop BR do Destiny 2: ler o mapa, rastrear esquadrões, lootar e sobreviver ao extract.',
		highlights: [
	...
	nl: {
		...
		lead: 'Destiny 2 Cheats volgt de raid-loop van Destiny 2: kaart lezen, vijandelijke squads volgen, looten en de extract overleven.',
		highlights: [
	...
	ko: {
		...
		lead: 'Destiny 2 Cheats는 Destiny 2 BR 루프용: 맵 읽기, 적 스쿼드 추적, 루트 수집, extract 생존.',
		highlights: [
	...
	zh: {
		...
		lead: 'Destiny 2 Cheats 为 Destiny 2 BR 循环设计：读图、追踪敌方小队、搜刮并在 extract 存活。',
		highlights: [
	...
	hi: {
		...
		lead: 'Destiny 2 Cheats Destiny 2 BR loop के लिए: map पढ़ें, enemy squads track करें, loot करें और extract survive करें।',
		highlights: [
	...
	sv: {
		...
		lead: 'Destiny 2 Cheats för Destiny 2:s raid-loop: läs kartan, spåra fiendesquads, loota och överlev extract.',
		highlights: [
