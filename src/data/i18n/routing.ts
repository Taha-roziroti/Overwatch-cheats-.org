...
export const englishPaths: Record<PageId, string> = {
	...
	faq: '/faq/',
	support: '/support/',
	undetected: '/ow2-undetected/',
	wallhack: '/ow2-wallhack/',
	radar: '/ow2-visuals/',
	'anticheat': '/ow2-anticheat/',
	'cheats-2026': '/ow2-cheats-2026/',
	hacks: '/ow2-cheats/',
	'cheat-download': '/ow2-download/',
	'crucible-cheats': '/ow2-hero-scripts/',
	'aim-assist': '/ow2-aim-assist/',
	'best-cheats': '/ow2-cheats/',
	'aimbot-hack': '/overwatch-2-aimbot/',
	'esp-hack': '/overwatch-2-esp/',
	'pve-cheats': '/ow2-hero-scripts/',
	privacy: '/privacy/',
	refund: '/refund/',
	terms: '/terms/',
};
