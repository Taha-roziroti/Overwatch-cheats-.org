...
export const productInfo = {
	...
	features: {
		esp: [
			'Player info, skeleton, and 2D/3D/cornered box ESP',
			'Glow, ult charge overlay, and target highlighting',
			'Draw FOV, lines, and enemy view angle',
			'Visual options for every ESP setting',
			'Stream-proof overlay rendering',
		],
		aimbot: [
			'Tracking, flickbot, and triggerbot',
			'Prediction, gravity prediction, and autoshoot',
			'Bone targeting, target closest bone, and aim layers',
			'FOV adjustment, hitbox scaling, and dynamic FOV',
			'Tracking speed, flick speed, and keybinds',
		],
		radar: [
			'Hero scripts — Genji, Tracer, Roadhog, and more',
			'Global auto-melee and hero-specific combos',
			'Skill keybinding in Aim 2',
		],
		general: [
			'Change ingame FOV and separate FOVs',
			'Automatic config saving and swapping',
			'Target lock and target allies toggle',
