...
const defaultImages: BrandSitemapImage[] = [
	{
		src: '/images/overwatch-2-cheats-esp.webp',
		title: 'Overwatch 2 cheats esp',
		caption: 'Overwatch 2 cheats esp wallhack',
	},
	{
		src: '/images/overwatch-2-cheats-wallhack.webp',
		title: 'Overwatch 2 cheats wallhack',
		caption: 'Overwatch 2 cheats wallhack esp',
	},
	{
		src: '/images/overwatch-2-cheats-aimbot.webp',
		title: 'Overwatch 2 cheats aimbot',
		caption: 'Overwatch 2 cheats aimbot soft aim',
	},
	{
		src: '/images/overwatch-2-cheats-aimbot-view.webp',
		title: 'Overwatch 2 cheats aimbot',
		caption: 'Overwatch 2 cheats aimbot view',
	},
	{
		src: '/images/overwatch-2-cheats-radar.webp',
		title: 'Overwatch 2 cheats radar',
		caption: 'Overwatch 2 cheats radar hack',
	},
	{
		src: '/images/overwatch-2-cheats-raid.webp',
		title: 'Overwatch 2 cheats',
		caption: 'Overwatch 2 cheats in raid',
	},
];
...
const pageImageTemplates: Record<PageId, { title: string; caption: string }> = {
	home: { title: '{brand} hero — ESP and aimbot in Overwatch 2', caption: 'Homepage preview of {primaryKeyword} on Windows PC' },
	'overwatch-2-esp': { title: '{primaryKeyword} ESP overlay', caption: 'Player ESP boxes and distance with {primaryKeyword}' },
	'overwatch-2-aimbot': { title: '{primaryKeyword} aimbot view', caption: 'Aimbot and soft aim controls in {primaryKeyword}' },
	...
	anticheat: { title: '{antiCheat} and {primaryKeyword}', caption: '{primaryKeyword} rebuilds after a Easy Anti-Cheat update' },
	'cheats-2026': { title: '{primaryKeyword} overview', caption: '{primaryKeyword} for Overwatch 2 on PC' },
