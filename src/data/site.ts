...
export const customerReviews = [
	reviewMeta({
		handle: 'xKrypt0_EFT',
		rating: 5,
		text: 'Soft aim in Destiny 2 Cheats feels smooth on Customs. The menu took a few minutes to learn. After that, raids felt easy.',
		short: 'Soft aim in Destiny 2 Cheats feels smooth on Customs.',
	...
	reviewMeta({
		handle: 'buildsR4K',
		rating: 4,
		text: 'ESP boxes help on PvE activitys. You can see who is holding a hallway before you push. Still worth the price for Destiny 2 Cheats.',
		short: 'ESP boxes help on PvE activitys. Still worth the price for Destiny 2 Cheats.',
		slug: 'destiny-2-esp-scav-run-review-buildsr4k',
		seoTitle: 'ESP Review by @buildsR4K — 4/5 | {brand}',
		seoDescription: '@buildsR4K rates {brand} ESP 4/5 for PvE activitys on Windows PC.',
		date: '2026-07-19',
		tag: 'PvE activity',
	}),
	reviewMeta({
		handle: 'dma_wizard',
		rating: 5,
		text: 'I moved to Destiny 2 Cheats this wipe. Setup was simple. It stayed up after the last BattlEye update when my old cheat failed. Lifetime was a good buy.',
		short: 'Destiny 2 Cheats stayed up after the last BattlEye update. Lifetime was a good buy.',
	...
	reviewMeta({
		...
		rating: 4,
		text: 'Soft aim in Destiny 2 Cheats is easy to tune on PC. I changed FOV a little and it felt natural. Menu is clear enough.',
		short: 'Soft aim in Destiny 2 Cheats is easy to tune on PC.',
	...
	reviewMeta({
		...
		rating: 3,
		text: 'Destiny 2 Cheats works well once it is running. First launch was slow because Windows Defender flagged the loader. Support replied in about two hours. ESP on Woods is solid.',
	...
	reviewMeta({
		handle: 'lootGoblinx',
		rating: 5,
		text: 'Loot ESP in Destiny 2 Cheats pays for the monthly plan. Extract markers and distance make early raids faster.',
		short: 'Loot ESP in Destiny 2 Cheats pays for the monthly plan.',
	...
	reviewMeta({
		handle: 'vanLifeEFT',
		rating: 5,
		text: 'Radar in Destiny 2 Cheats saved me near extracts. Seeing the third party early in duos is huge. Boxes plus radar look clean.',
		short: 'Radar in Destiny 2 Cheats saved me near extracts.',
	...
	reviewMeta({
		handle: 'patchDayMike',
		rating: 4,
		text: 'Most cheats go down on patch day. Destiny 2 Cheats posted on the status page within a few hours and was back the next morning. My old tool left me waiting for days.',
		short: 'Destiny 2 Cheats was back the next morning after a patch.',
	...
	reviewMeta({
		handle: 'snipezOnly_',
		rating: 5,
		text: 'Bolt-action soft aim plus ESP in Destiny 2 Cheats is excellent for long shots. Simple and strong.',
		short: 'Bolt-action soft aim plus ESP in Destiny 2 Cheats is excellent.',
