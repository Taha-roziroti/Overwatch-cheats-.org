...
const PAGE_META_HOME = {
	...
	nl: { title: 'Destiny 2 Cheats 2026 | ESP, Wallhack & Aimbot', desc: 'Undetected Destiny 2 cheats voor Destiny 2 op PC. ESP wallhack, radar hack en Aimbot met BattlEye anti-cheat-onderhoud. Directe digitale levering.', h1: 'Destiny 2 Cheats — Undetected ESP, Wallhack & Aimbot', intro: 'Undetected Windows PC pakket voor Destiny 2: ESP wallhack, radar en Aimbot met BattlEye anti-cheat-onderhoud na elke patch.', imageAlt: 'Destiny 2 ESP player tags hack', gallery: 'Destiny 2 Cheats galerij — ESP, Aimbot en wallhack', cta2: 'Bekijk functies', h2a: 'Waarom Destiny 2 Cheats in 2026', h2b: 'ESP wallhack, radar en Aimbot in één licentie', topicA: 'Ideaal om vijandelijke squads te lezen in Crucible en PvE.', topicB: 'Eén licentie in plaats van losse tools.' },
	...
	ar: { title: 'Destiny 2 Cheats 2026 | ESP وWallhack وAimbot', desc: 'غش Destiny 2 undetected لـ Destiny 2 على PC. ESP wallhack ورadar hack وAimbot مع صيانة BattlEye anti-cheat. تسليم رقمي فوري.', h1: 'Destiny 2 Cheats — ESP وWallhack وAimbot غير مكتشف', intro: 'حزمة undetected لـ Destiny 2 على Windows PC: ESP wallhack ورadar وAimbot مع صيانة BattlEye anti-cheat.', imageAlt: 'Destiny 2 ESP player tags hack', gallery: 'معرض Destiny 2 Cheats — ESP وAimbot وwallhack', cta2: 'عرض الميزات', h2a: 'لماذا Destiny 2 Cheats في 2026', h2b: 'ESP wallhack ورadar وAimbot في ترخيص واحد', topicA: 'مثالي لقراءة فرق العدو في Crucible وPvE.', topicB: 'ترخيص واحد بدلاً من أدوات منفصلة.' },
	...
	zh: { title: 'Destiny 2 Cheats 2026 | ESP、Wallhack、Aimbot', desc: 'Destiny 2 undetected作弊。ESP wallhack、radar hack、Aimbot、BattlEye anti-cheat维护。即时数字交付。', h1: 'Destiny 2 Cheats — Undetected ESP、Wallhack、Aimbot', intro: 'Destiny 2 Windows PC undetected套餐：ESP wallhack、radar、Aimbot，含BattlEye anti-cheat维护。', imageAlt: 'Destiny 2 cheats hero ESP aimbot wallhack', gallery: 'Destiny 2 Cheats图库 — ESP、Aimbot、wallhack', cta2: '查看功能', h2a: '2026年选择Destiny 2 Cheats的原因', h2b: 'ESP wallhack、radar、Aimbot单一许可证', topicA: '适合在Crucible和PvE中读取敌方小队。', topicB: '一个许可证而非多个工具。' },
	...
	id: { title: 'Destiny 2 Cheats 2026 | ESP, Wallhack & Aimbot', desc: 'Cheat Destiny 2 undetected untuk Destiny 2 di PC. ESP wallhack, radar hack, Aimbot, pemeliharaan BattlEye anti-cheat. Pengiriman digital instan.', h1: 'Destiny 2 Cheats — Undetected ESP, Wallhack & Aimbot', intro: 'Paket undetected Destiny 2 di Windows PC: ESP wallhack, radar, Aimbot dengan pemeliharaan BattlEye anti-cheat.', imageAlt: 'Destiny 2 ESP player tags hack', gallery: 'Galeri Destiny 2 Cheats — ESP, Aimbot, wallhack', cta2: 'Lihat fitur', h2a: 'Mengapa Destiny 2 Cheats di 2026', h2b: 'ESP wallhack, radar, Aimbot dalam satu lisensi', topicA: 'Ideal membaca squad musuh di Crucible dan PvE.', topicB: 'Satu lisensi alih-alih alat terpisah.' },
	...
	vi: { title: 'Destiny 2 Cheats 2026 | ESP, Wallhack & Aimbot', desc: 'Cheat Destiny 2 undetected cho Destiny 2 trên PC. ESP wallhack, radar hack, Aimbot, bảo trì BattlEye anti-cheat. Giao hàng kỹ thuật số tức thì.', h1: 'Destiny 2 Cheats — Undetected ESP, Wallhack & Aimbot', intro: 'Gói undetected Destiny 2 trên Windows PC: ESP wallhack, radar, Aimbot với bảo trì BattlEye anti-cheat.', imageAlt: 'Destiny 2 ESP player tags hack', gallery: 'Thư viện Destiny 2 Cheats — ESP, Aimbot, wallhack', cta2: 'Xem tính năng', h2a: 'Vì sao chọn Destiny 2 Cheats 2026', h2b: 'ESP wallhack, radar, Aimbot trong một giấy phép', topicA: 'Lý tưởng đọc squad địch trong Crucible và PvE.', topicB: 'Một giấy phép thay vì công cụ riêng.' },
