...
export const enPages = {
	home: {
		...
		description:
			'Official Overwatch 2 cheats for Windows PC — aimbot, ESP, wallhack, radar, and Easy Anti-Cheat updates. Compare plans and buy with instant delivery.',
		h1: 'Overwatch 2 Cheats',
		intro:
			'Undetected Overwatch 2 cheats for Windows PC — ESP, soft aim, and radar in one license with Easy Anti-Cheat maintenance after patches.',
		...
		sections: [
			section(
				...
				'Overwatch 2 rewards map awareness. Overwatch 2 Cheats combines ESP for heroes and enemies, radar-style threat cues, and configurable aimbot so you can read fights before committing in Quick Play, Competitive, and raids.',
				`Official seasons, patches, and anti-cheat updates come from ${EXT['destiny-2']} and ${EXT.easy-anticheat}. We rebuild ESP, radar, and aimbot modules when those patches require maintenance — then post status on the <a href="/status/">Updates page</a>.`,
				'Licenses ship digitally after payment. Monthly ($35) and lifetime ($150) plans include Easy Anti-Cheat rebuilds when anti-cheat or game patches require updates.',
			),
			section(
	...
	'overwatch-2-esp': {
		...
		description:
			'Overwatch 2 ESP for Windows PC — player boxes, loot markers, and distance readouts. Part of our undetected Overwatch 2 cheats.',
		h1: 'Overwatch 2 ESP — Player Boxes & Wallhack',
		intro:
			'Player boxes, loot markers, and distance readouts for Quick Play, Competitive, and raids. Toggle categories so the overlay stays readable mid-match.',
		imageAlt: "Overwatch 2 ESP player boxes and distance readouts in a raid",
		...
		sections: [
			section(
				'What Overwatch 2 ESP solves in raids',
				'Overwatch 2 maps punish incomplete information. Overwatch 2 Cheats ESP wallhack helps you spot enemy squads early, spot heroes and enemies before they push your angle, and mark powerful loot worth the detour.',
				'In raids, strikes, and Quick Play matches, that visibility gap is often the difference between a clean flank and a wiped fireteam. ESP ships bundled with radar overlays and Aimbot in one license.',
				`Overwatch 2’s live seasons and map updates are published by Bungie (${EXT['destiny-2']}). When POIs or loot rules shift, ESP categories stay useful because they track players and containers — not a single static landmark.`,
			),
			section(
			...
			section(
				...
				'Overwatch 2 Cheats ESP wallhack is maintained for Overwatch 2 with rebuilds after Easy Anti-Cheat anti-cheat patches. Check the <a href="/status/">Updates page</a> before you queue — no cheat guarantees permanent undetected status.',
				`Read ${EXT.easy-anticheat} for how anti-cheat updates ship, then cross-check our <a href="/status/">Easy Anti-Cheat bypass maintenance guide</a> after major patches.`,
	...
	'overwatch-2-aimbot': {
		title: 'Overwatch 2 Aimbot | Soft Aim for Windows PC',
		description:
			'Overwatch 2 aimbot with soft aim tuning for Windows PC. FOV, bone priority, and hotkeys bundled with ESP boxes in our Overwatch 2 cheats package.',
		h1: 'Overwatch 2 Aimbot — Soft Aim for Windows PC',
		intro:
			'Soft aim with FOV, smoothness, and bone priority you can tune per weapon. Ships with ESP and radar in one license.',
		imageAlt: "Overwatch 2 aimbot and soft aim controls on Windows PC",
		...
		sections: [
			section(
				...
				'Overwatch 2 mixes long-range AR fights with close-quarters SMG pushes. Overwatch 2 Cheats Aimbot includes smoothness, FOV, and sensitivity controls tuned for that pace — with hotkey toggles mid-match.',
			...
			section(
				...
				'Overwatch 2 Cheats rebuilds Aimbot behavior when Easy Anti-Cheat anti-cheat or major Overwatch 2 patches land. Maintenance notes appear on the <a href="/status/">Updates page</a> so you know when a new build is live.',
				`Cross-check service health on ${EXT.status} and anti-cheat context on ${EXT.easy-anticheat}, then follow our <a href="/status/">Easy Anti-Cheat maintenance guide</a> before queueing on patch day.`,
	...
	features: {
		title: 'Overwatch 2 Cheats Features | ESP, Soft Aim & Radar',
		description:
			'Full Overwatch 2 cheats feature list: ESP boxes, soft aim, radar, and toggles for Windows PC. Review controls before checkout.',
		h1: 'Overwatch 2 Cheats Features — Full Control List',
		intro:
			'Every ESP wallhack, radar hack, and Aimbot control included in the Overwatch 2 Cheats package on Windows PC — with Easy Anti-Cheat maintenance after major patches.',
		imageAlt: "Overwatch 2 Cheats features — ESP, soft aim, and radar screenshots",
		...
		sections: [
			section(
				...
				'Team and enemy colour coding supports raids and PvE. Deep-dive the <a href="/overwatch-2-esp/">ESP page</a> and <a href="/overwatch-2-esp/">wallhack guide</a> for category-level detail.',
	...
	pricing: {
		...
		description:
			'Overwatch 2 cheats pricing: $35/month or $150 lifetime for ESP, soft aim, and radar on Windows PC. Instant delivery — pick a plan.',
		h1: 'Overwatch 2 Cheats Pricing — Monthly & Lifetime',
		intro:
			'Choose monthly or lifetime access to undetected Overwatch 2 Cheats — ESP wallhack, radar hack, and Aimbot for Overwatch 2 on Windows PC. Instant digital delivery after payment.',
		...
		sections: [
			...
			section(
				...
				'Player ESP wallhack, loot markers, 2D radar overlays, Aimbot controls, in-client toggles, and maintenance rebuilds after Easy Anti-Cheat anti-cheat or major Overwatch 2 patches.',
	...
	setup: {
		...
		description:
			'Set up Overwatch 2 cheats on Windows PC — activate ESP boxes, soft aim profiles, and radar. Check Easy Anti-Cheat updates before your first queue.',
		h1: 'Overwatch 2 Cheats Setup — Windows PC Guide',
		intro:
			'Install and configure Overwatch 2 Cheats for Overwatch 2 on Windows 10 or 11. Activate your license, load ESP wallhack and Aimbot profiles, and verify Easy Anti-Cheat maintenance status before queueing.',
		...
		sections: [
			section(
				...
				'Confirm your order email and license details. Check the <a href="/status/">Updates page</a> for the latest Easy Anti-Cheat maintenance build before launching Overwatch 2.',
	...
	updates: {
		title: 'Overwatch 2 Cheats Updates | Easy Anti-Cheat Maintenance Log',
		description:
			'Overwatch 2 cheats update log: Easy Anti-Cheat rebuilds for ESP boxes, soft aim, and radar on Windows PC. Check status before queueing after patches.',
		h1: 'Overwatch 2 Cheats Updates — Maintenance Log',
		intro:
			'Track Easy Anti-Cheat maintenance and Overwatch 2 patch rebuilds for the undetected ESP wallhack, radar hack, and Aimbot package. Check here before queueing after major updates.',
		imageAlt: "Overwatch 2 Cheats live status after Easy Anti-Cheat and game patches",
		...
		sections: [
			section(
				...
				'Overwatch 2 and Easy Anti-Cheat anti-cheat receive frequent patches. Overwatch 2 Cheats publishes maintenance notes when ESP wallhack, radar, or Aimbot behavior needs a rebuild.',
				`Use ${EXT.status} for Bungie platform health and this page for Overwatch 2 Cheats build status — both matter on big update days.`,
	...
	faq: {
		title: 'Overwatch 2 Cheats FAQ | ESP, Soft Aim & Radar Answers',
		description:
			'Overwatch 2 cheats FAQ: ESP boxes, soft aim, Easy Anti-Cheat maintenance, and pricing for PC. Clear answers before you buy.',
		h1: 'Overwatch 2 Cheats FAQ — Common Questions',
		intro:
			'Answers about undetected Overwatch 2 Cheats — ESP wallhack, radar hack, Aimbot, Easy Anti-Cheat maintenance, checkout, and Overwatch 2 compatibility on Windows PC.',
		...
		sections: [
			section(
				...
				'Overwatch 2 Cheats is an undetected cheat package for Overwatch 2 on Windows PC. It includes ESP wallhack, 2D radar-style awareness, and Aimbot controls with Easy Anti-Cheat maintenance updates.',
				'Packages cover raids and PvE. Explore <a href="/features/">Features</a> for the full control list and <a href="/overwatch-2-esp/">ESP</a> / <a href="/overwatch-2-aimbot/">Aimbot</a> for module detail.',
				`Overwatch 2 itself is published by Bungie (${EXT['destiny-2']}). Cheats are third-party tools and may violate Bungie's rules — use is at your own risk.`,
			),
			section(
	...
	support: {
		...
		description:
			'Contact Overwatch 2 cheats support for licenses, ESP setup, soft aim profiles, and radar on Windows PC. Include your order ID for faster help.',
		h1: 'Overwatch 2 Cheats Support — Contact Us',
		intro:
			'Get help with Overwatch 2 Cheats licenses, checkout, ESP wallhack setup, Aimbot profiles, and Easy Anti-Cheat maintenance for Overwatch 2 on Windows PC.',
		...
		sections: [
			...
			section(
				...
				'Support requests are reviewed daily. Overwatch 2 Cheats support covers delivery, billing, setup, and maintenance — not in-game coaching or account recovery for Bungie bans.',
	...
	undetected: {
		title: 'Undetected Overwatch 2 Cheats | Easy Anti-Cheat Maintenance',
		description:
			'Undetected Overwatch 2 cheats with Easy Anti-Cheat maintenance for ESP boxes, soft aim, and radar on Windows PC. Check status before you queue.',
		h1: 'Undetected Overwatch 2 Cheats — Easy Anti-Cheat Maintenance',
		intro:
			'How Overwatch 2 Cheats stays maintained for Overwatch 2 after Easy Anti-Cheat anti-cheat patches — ESP wallhack, radar hack, and Aimbot rebuilds for Windows PC.',
		...
		sections: [
			section(
				...
				'Undetected Overwatch 2 Cheats means the package is actively maintained against Easy Anti-Cheat anti-cheat and major Overwatch 2 patches — not that detection is impossible forever.',
				'Rebuilds target ESP wallhack overlays, radar behavior, and Aimbot signatures after Easy Anti-Cheat security updates.',
				`Anti-cheat technology is documented by ${EXT.easy-anticheat}; Overwatch 2 client updates ship through ${EXT['destiny-2']}. Undetected status is an ongoing process tied to those releases.`,
			),
			section(
				'Easy Anti-Cheat maintenance workflow',
				'When Easy Anti-Cheat anti-cheat or Overwatch 2 updates ship, the team assesses ESP, radar, and Aimbot modules, publishes status on the <a href="/status/">Updates page</a>, and delivers rebuilt builds to active licenses.',
				`On patch mornings, also check ${EXT.status} for launcher outages that can look like product failures.`,
				'Deep technical workflow: <a href="/status/">Easy Anti-Cheat bypass Overwatch 2 guide</a>. Feature stack: <a href="/features/">Features</a>.',
			),
			section(
	...
	wallhack: {
		...
		description:
			'Overwatch 2 wallhack ESP with player boxes and loot markers for Windows PC. Undetected Overwatch 2 cheats — learn overlays and buy.',
		h1: 'Overwatch 2 Wallhack — ESP Boxes & Visibility',
		intro:
			'Overwatch 2 wallhack ESP for Overwatch 2 — see players, loot, bosses, and containers through toggleable wallhack overlays built for raids and PvE.',
		imageAlt: "Overwatch 2 wallhack visibility through walls in a raid",
		...
		sections: [
			section(
				...
				'A Overwatch 2 wallhack focuses on information — player outlines, loot pins, boss threat cues — rather than automatic aiming. Overwatch 2 Cheats bundles wallhack ESP with radar and optional Aimbot in one license.',
			...
			section(
				...
				'ESP wallhack modules rebuild after Easy Anti-Cheat anti-cheat patches. Follow the <a href="/status/">Updates page</a> and complete checkout for instant license delivery on Windows PC.',
	...
	radar: {
		title: 'Overwatch 2 Radar Hack | 2D Threat Overlay',
		description:
			'Overwatch 2 radar hack for flank awareness on Windows PC. Bundled with ESP boxes, soft aim, and radar in our Overwatch 2 cheats package.',
		h1: 'Overwatch 2 Radar Hack — 2D Threat Awareness',
		intro:
			'2D radar-style overlay for Overwatch 2 — directional threat cues for nearby players outside your line of sight, bundled with ESP wallhack and Aimbot.',
		imageAlt: "Overwatch 2 2D radar overlay showing nearby threats",
		galleryTitle: 'Overwatch 2 radar hack visuals',
		ctaPrimary: 'Buy Overwatch 2 Cheats',
		ctaSecondary: 'See ESP wallhack',
		ctaSecondaryHref: '/overwatch-2-esp/',
		sections: [
			section(
				'Why radar hack matters in Overwatch 2',
			...
			section(
				...
				'Radar hack modules receive Easy Anti-Cheat maintenance rebuilds with the full Overwatch 2 Cheats package. Monthly and lifetime licenses include digital delivery — see <a href="/pricing/">Pricing</a>.',
	...
	'anticheat': {
		title: 'Easy Anti-Cheat Bypass Overwatch 2 | Overwatch 2 Cheats Maintenance',
		description:
			'How Overwatch 2 cheats rebuild after Easy Anti-Cheat patches — ESP boxes, soft aim, and radar maintenance for Windows PC. Read before queueing.',
		h1: 'Easy Anti-Cheat Bypass — Overwatch 2 Cheats Maintenance',
		intro:
			'Understand Easy Anti-Cheat anti-cheat maintenance for Overwatch 2 Cheats — how ESP wallhack, radar hack, and Aimbot rebuild after Overwatch 2 security updates.',
		imageAlt: "Overwatch 2 Cheats maintenance after a Easy Anti-Cheat patch",
		...
		sections: [
			section(
				'Easy Anti-Cheat anti-cheat overview',
				`Easy Anti-Cheat anti-cheat is Bungie's anti-cheat for Overwatch 2 on PC (see ${EXT.easy-anticheat}). Security updates can affect ESP wallhack, radar, and Aimbot behavior — requiring maintenance rebuilds for undetected packages.`,
				`Overwatch 2 Cheats monitors Easy Anti-Cheat patch notes and Overwatch 2 seasonal updates from ${EXT['destiny-2']} to schedule module reviews.`,
	...
	'cheats-2026': {
		title: 'Overwatch 2 Cheats | ESP Soft Aim & Radar',
		description:
			'Best Overwatch 2 cheats 2026: ESP boxes, soft aim, and radar for Windows PC. Undetected Overwatch 2 cheats with Easy Anti-Cheat maintenance — compare and buy.',
		h1: 'Overwatch 2 Cheats 2026 — ESP, Soft Aim & Radar',
		intro:
			'The 2026 Overwatch 2 Cheats package for Overwatch 2 — undetected ESP wallhack, radar hack, and Aimbot with Easy Anti-Cheat maintenance, instant delivery, and Windows PC support.',
		...
		sections: [
			section(
				...
				'2026 seasons bring new maps, weapons, and Easy Anti-Cheat anti-cheat updates. Overwatch 2 Cheats bundles ESP wallhack, radar hack, and Aimbot with active maintenance — not a stale prior-year build.',
	...
	hacks: {
		...
		description:
			'Purchase undetected Overwatch 2 cheats for Windows PC — ESP, aimbot, radar, and Easy Anti-Cheat rebuilds. Monthly and lifetime plans with instant delivery.',
		h1: 'Buy Overwatch 2 Cheats',
		intro:
			'Overwatch 2 Cheats for Windows PC — ESP, soft aim, and radar in one license with Easy Anti-Cheat rebuilds after patches.',
		...
		sections: [
			section(
				...
				'The stack includes ESP with distance readouts, soft aim profiles, 2D radar for flanks, and Easy Anti-Cheat rebuilds after patches.',
	...
	'cheat-download': {
		...
		description:
			'Overwatch 2 cheat download with instant license delivery — ESP boxes, soft aim, and radar for Windows PC. Buy, activate, and play.',
		h1: 'Overwatch 2 Hack Download — Instant License Delivery',
		intro:
			'How Overwatch 2 cheat download works for Overwatch 2 — digital license delivery after payment confirmation, with ESP wallhack, radar hack, and Aimbot access on Windows PC.',
		...
		sections: [
			...
			section(
				...
				'Every Overwatch 2 cheat download includes player ESP wallhack, loot and container markers, 2D radar overlays, Aimbot profiles, and in-client toggles for raids and PvE.',
			...
			section(
				...
				'Follow Setup to activate ESP wallhack and Aimbot on Windows 10 or 11. When Overwatch 2 or Easy Anti-Cheat anti-cheat patches ship, check the <a href="/status/">Updates page</a> for maintenance rebuilds.',
	...
	'crucible-cheats': {
		title: 'Overwatch 2 Mod Menu | ESP & Soft Aim Toggles',
		description:
			'Overwatch 2 mod menu for in-match toggles — ESP boxes, soft aim, radar, and on Windows PC. Undetected Overwatch 2 cheats package.',
		...
		sections: [
			...
			section(
				...
				'Soft tracking players should start with <a href="/overwatch-2-aimbot/">soft aim</a> profiles before aggressive FOV.',
			),
			section(
				'Maintained mod menu after Easy Anti-Cheat patches',
				'Overwatch 2 mod menu behavior is rebuilt when Easy Anti-Cheat anti-cheat or major Overwatch 2 updates land. Follow the <a href="/status/">Updates page</a> and <a href="/status/">Easy Anti-Cheat bypass guide</a> before queueing on patch days.',
	...
	'aim-assist': {
		title: 'Overwatch 2 Soft Aim | Smooth Aimbot Settings',
		description:
			'Overwatch 2 soft aim settings for natural tracking on Windows PC. Smoothness, FOV, and bone priority — included in our Overwatch 2 cheats with ESP boxes.',
		h1: 'Overwatch 2 Soft Aim — Smooth Aimbot Controls',
		intro:
			'Overwatch 2 soft aim settings for Overwatch 2 — configurable Aimbot smoothness, FOV, bone priority, and hotkey toggles bundled with ESP wallhack and radar in one undetected license.',
		imageAlt: "Overwatch 2 soft aim FOV and smoothness settings",
		galleryTitle: 'Overwatch 2 soft aim gallery',
		ctaPrimary: 'Buy Overwatch 2 Cheats',
		ctaSecondary: 'Aimbot controls',
		ctaSecondaryHref: '/overwatch-2-aimbot/',
		sections: [
			section(
				'What Overwatch 2 soft aim means',
				'Overwatch 2 soft aim refers to Aimbot behavior tuned for smooth, natural-looking tracking rather than instant snap. Overwatch 2 Cheats exposes smoothness, FOV, and sensitivity sliders so you control how assist feels in Quick Play firefights.',
			...
			section(
				...
				'Aimbot modules rebuild after Easy Anti-Cheat anti-cheat patches. Check the <a href="/status/">Updates page</a> before queueing — responsible settings and maintenance awareness matter for undetected play.',
	...
	'best-cheats': {
		...
		description:
			'Best Overwatch 2 cheats for 2026: ESP boxes, soft aim, and Easy Anti-Cheat maintenance on Windows PC. Use this checklist before checkout.',
		h1: 'Best Overwatch 2 Cheats — 2026 Buyer Guide',
		intro:
			'Compare the Overwatch 2 cheats for Overwatch 2 in 2026 — undetected ESP wallhack, radar hack, and Aimbot in one maintained package with Easy Anti-Cheat anti-cheat rebuilds and instant delivery.',
		...
		sections: [
			section(
				...
				'The Overwatch 2 cheats combine active Easy Anti-Cheat maintenance, a full ESP wallhack and radar stack, configurable Aimbot, and clear update communication — not a stale build from a prior season.',
				'Overwatch 2 Cheats covers raids and PvE with in-client toggles and post-patch rebuilds.',
			...
			section(
				...
				'Look for player ESP wallhack, loot markers, 2D radar overlays, Aimbot profiles, hotkey toggles, and documented maintenance after Overwatch 2 patches.',
	...
	'aimbot-hack': {
		...
		description:
			'Overwatch 2 aimbot hack with soft aim for Windows PC. FOV, bone priority, and hotkeys — bundled with ESP boxes in our Overwatch 2 cheats package.',
		h1: 'Overwatch 2 Aimbot Hack — Soft Aim Assist',
		intro:
			'Overwatch 2 aimbot hack tools for Overwatch 2 — smoothness, FOV, bone priority, per-weapon profiles, and hotkey toggles bundled with ESP wallhack and radar in one undetected license.',
		...
		sections: [
			section(
				...
				'Smoothness, FOV, and sensitivity controls tune assist for Overwatch 2 combat pace across raids and PvE.',
				'Prefer softer tracking language? See <a href="/overwatch-2-aimbot/">soft aim</a>. Full settings: <a href="/overwatch-2-aimbot/">Aimbot page</a>.',
			),
			section(
			...
			section(
				...
				'Aimbot hack signatures rebuild after Easy Anti-Cheat anti-cheat updates. Follow the <a href="/status/">Updates page</a> and <a href="/status/">Easy Anti-Cheat bypass guide</a> before queueing after patch days.',
	...
	'esp-hack': {
		...
		description:
			'Overwatch 2 ESP hack with player boxes and loot markers for Windows PC. Undetected Overwatch 2 cheats with — see overlays and buy.',
		h1: 'Overwatch 2 ESP Hack — Player Boxes Guide',
		intro:
			'Overwatch 2 ESP hack overlays for Overwatch 2 — player outlines, boss threat cues, loot and container markers with distance readouts across raids and PvE.',
		imageAlt: "Overwatch 2 ESP hack boxes and loot markers",
		...
		sections: [
			section(
				...
				'A Overwatch 2 ESP hack renders enemy player outlines, vehicle positions, and loot pins through walls and terrain — closing the information gap before you commit to a fight.',
	...
	'pve-cheats': {
		...
		description:
			'Overwatch 2 unlock all explained vs real Overwatch 2 cheats — ESP boxes, soft aim, and radar for Windows PC. Know what you are buying.',
		h1: 'Overwatch 2 Unlock All — What Players Search For',
		intro:
			'Overwatch 2 unlock all is a common search term for Overwatch 2 — this page clarifies what pve-cheats tools claim versus the ESP wallhack, radar hack, and Aimbot tools Overwatch 2 Cheats actually provides on Windows PC.',
		...
		sections: [
			section(
				...
				'Overwatch 2 Cheats focuses on in-match awareness — player ESP, loot markers, radar overlays, and configurable Aimbot — not account-wide cosmetic unlocks.',
			...
			section(
				...
				'If you need undetected ESP wallhack, radar hack, and Aimbot for Overwatch 2 on Windows PC, compare <a href="/pricing/">Pricing</a> and read the <a href="/setup/">Setup guide</a> before checkout.',
				'Check the <a href="/status/">Updates page</a> after Easy Anti-Cheat anti-cheat patches — maintenance rebuilds publish for active licenses.',
	...
	refund: {
		...
		description:
			'Refund policy for Overwatch 2 Cheats. Digital delivery terms and eligibility for Overwatch 2 cheats packages with ESP, soft aim, and radar.',
		h1: 'Refund Policy',
		intro:
			'Refund terms for Overwatch 2 Cheats licenses — ESP wallhack, radar hack, and Aimbot packages purchased through checkout for Overwatch 2.',
	...
	terms: {
		...
		sections: [
			section(
				...
				'By purchasing or using Overwatch 2 Cheats you agree to these terms. Licenses grant personal use of ESP wallhack, radar, and Aimbot tools for Overwatch 2 on Windows PC only.',
