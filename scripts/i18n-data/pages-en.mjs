...
export const enPages = {
	home: {
		...
		intro:
			'Undetected Destiny 2 cheats for Windows PC — ESP wallhack, 2D radar, and aimbot in one license, with BattlEye rebuilds after major patches.',
		...
		sections: [
			section(
				...
				`Official seasons, patches, and anti-cheat updates come from ${EXT.destiny-2} and ${EXT.battleye}. We rebuild ESP, radar, and Aimbot modules when those patches require maintenance — then post status on the <a href="/destiny-2-cheats-status/">Updates page</a>.`,
	...
	'destiny-2-esp': {
		...
		sections: [
			...
			section(
				...
				`Read ${EXT.battleye} for how anti-cheat updates ship, then cross-check our <a href="/destiny-2-cheats-status/">BattlEye bypass maintenance guide</a> after major patches.`,
	...
	'destiny-2-aimbot': {
		...
		sections: [
			...
			section(
				...
				`Cross-check service health on ${EXT.status} and anti-cheat context on ${EXT.battleye}, then follow our <a href="/destiny-2-cheats-status/">BattlEye maintenance guide</a> before queueing on patch day.`,
	...
	features: {
		...
		sections: [
			...
			section(
				...
				`Monitor ${EXT.status} on patch days, then confirm rebuild notes before you queue. Setup and billing help lives on <a href="/destiny-2-cheats-support/">Support</a> and support@destiny2cheats.org.`,
	...
	pricing: {
		...
		sections: [
			...
			section(
				...
				`Season calendars and client updates come from ${EXT.destiny-2}. Active licenses receive rebuild access when we publish maintenance on <a href="/destiny-2-cheats-status/">Updates</a>.`,
	...
	setup: {
		...
		sections: [
			...
			section(
				...
				`Official anti-cheat background: ${EXT.battleye}. Our practical workflow is documented on the <a href="/destiny-2-cheats-status/">BattlEye bypass page</a> and <a href="/destiny-2-cheats/">undetected guide</a>.`,
	...
	undetected: {
		...
		sections: [
			section(
				...
				`Anti-cheat technology is documented by ${EXT.battleye}; Destiny 2 client updates ship through ${EXT['destiny-2']}. Undetected status is an ongoing process tied to those releases.`,
			),
			section(
	...
	'cheats-2026': {
		...
		sections: [
			section(
				...
				`Track official season messaging on ${EXT.destiny-2}, then use our <a href="/destiny-2-cheats-status/">Updates log</a> for product rebuild timing.`,
	...
	hacks: {
		...
		intro:
			'Destiny 2 cheats for raids and PvE combine ESP wallhack visibility, 2D radar-style threat cues, and Aimbot controls in one undetected Windows PC license — maintained after BattlEye anti-cheat patches. This is the pillar guide for Destiny 2 cheats in 2026.',
		...
		sections: [
			section(
				...
				`Official game updates come from ${EXT.destiny-2}; our hacks package tracks those releases via the <a href="/destiny-2-cheats-status/">Updates page</a>. Cross-check platform health on ${EXT.status} before patch-day queues.`,
			),
			section(
			...
			section(
				...
				`See ${EXT.battleye} for anti-cheat background and our <a href="/destiny-2-cheats-status/">BattlEye bypass guide</a> for the practical workflow. Pair with <a href="/destiny-2-cheats/">undetected Destiny 2 cheats</a> for status language buyers expect.`,
	...
	'best-cheats': {
		...
		sections: [
			section(
				...
				`Verify the live game is healthy via ${EXT.status}, then confirm our <a href="/destiny-2-cheats-status/">Updates</a> note before you judge any package “best.”`,
			),
			section(
