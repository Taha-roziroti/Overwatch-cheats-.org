...
export const uiStrings = {
	...
	de: {
		...
		hero: { accent: 'Overwatch 2 Cheats für PC', accentShort: 'Overwatch 2 Cheats', subtitle: 'ESP Wallhack, Wallhack und Aimbot für Overwatch 2 auf Windows PC — Blizzard Anti-Cheat-Wartung inklusive.', subtitleShort: 'ESP, Radar & Aimbot für Overwatch 2 PC', buyNow: 'Jetzt kaufen', seeFeatures: 'Features ansehen' },
		...
		product: { title: 'Overwatch 2 Cheats', addToCart: 'In den Warenkorb', monthly: 'Monatlich', lifetime: 'Lifetime', available: 'Jetzt verfügbar', gameBadge: 'Overwatch 2', platformBadge: 'Windows PC', statusBadge: 'Live-Paket' },
	...
	it: {
		nav: { home: 'Inizio', hacks: 'Cheats', aimbot: 'Aimbot', esp: 'ESP', features: 'Funzioni', pricing: 'Prezzi', setup: 'Setup', updates: 'Aggiornamenti', faq: 'FAQ', buyNow: 'Acquista' },
	...
	nl: {
		nav: { home: 'Start', hacks: 'Cheats', aimbot: 'Aimbot', esp: 'ESP', features: 'Functies', pricing: 'Prijzen', setup: 'Setup', updates: 'Updates', faq: 'FAQ', buyNow: 'Kopen' },
		hero: { accent: 'Overwatch 2 cheats voor PC', accentShort: 'Overwatch 2 Cheats', subtitle: 'ESP and wallhack en Aimbot voor Overwatch 2 op Windows PC — Blizzard Anti-Cheat-onderhoud inbegrepen.', subtitleShort: 'ESP, wallhack & Aimbot voor Overwatch 2 PC', buyNow: 'Nu kopen', seeFeatures: 'Bekijk functies' },
		...
		product: { title: 'Overwatch 2 Cheats', addToCart: 'In winkelwagen', monthly: 'Maandelijks', lifetime: 'Lifetime', available: 'Nu beschikbaar', gameBadge: 'Overwatch 2', platformBadge: 'Windows PC', statusBadge: 'Live pakket' },
	...
	pl: {
		...
		hero: { accent: 'Cheats do Overwatch 2 na PC', accentShort: 'Overwatch 2 Cheats', subtitle: 'ESP and wallhack i Aimbot do Overwatch 2 na PC Windows — konserwacja Blizzard Anti-Cheat w cenie.', subtitleShort: 'ESP, wallhack i Aimbot dla Overwatch 2 PC', buyNow: 'Kup teraz', seeFeatures: 'Zobacz funkcje' },
	...
	ru: {
		...
		hero: { accent: 'Читы Overwatch 2 для PC', accentShort: 'Overwatch 2 Cheats', subtitle: 'ESP and wallhack и Aimbot для Overwatch 2 на Windows PC — обслуживание Blizzard Anti-Cheat включено.', subtitleShort: 'ESP, wallhack и Aimbot для Overwatch 2 PC', buyNow: 'Купить', seeFeatures: 'Смотреть функции' },
	...
	tr: {
		...
		hero: { accent: 'Overwatch 2 PC hileleri', accentShort: 'Overwatch 2 Cheats', subtitle: 'Overwatch 2 Windows PC için ESP and wallhack ve Aimbot — Blizzard Anti-Cheat bakımı dahil.', subtitleShort: 'Overwatch 2 PC için ESP, wallhack ve Aimbot', buyNow: 'Satın al', seeFeatures: 'Özellikleri gör' },
