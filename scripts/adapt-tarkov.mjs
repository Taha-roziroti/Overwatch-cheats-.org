...
const RENAME_PAGE_DIRS = [
	...
	['ricochet-bypass', 'easy-anticheat-bypass'],
...
const REPLACEMENTS = [
	...
	['warzone-esp', 'tarkov-esp'],
	['ricochet-bypass', 'easy-anticheat-bypass'],
	["'ricochet'", "'easy-anticheat'"],
	['| ricochet', '| easy-anticheat'],
	['pageId="ricochet"', 'pageId="easy-anticheat"'],
	['pageId: \'ricochet\'', "pageId: 'easy-anticheat'"],
	['"ricochet"', '"easy-anticheat"'],
	...
	['Ricochet anti-cheat', 'Easy Anti-Cheat anti-cheat'],
...
async function updatePageAstroFiles() {
	const idMap = {
		...
		'easy-anticheat-bypass': 'easy-anticheat',
		'tarkov-cheats': 'hacks',
