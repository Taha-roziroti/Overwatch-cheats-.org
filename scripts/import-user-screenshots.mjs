...
const assetsDir =
	'C:/Users/Aman/.cursor/projects/c-Users-Aman-destiny-2hacks/assets';
...
const USER_SCREENSHOTS = [
	{
		...
		file: 'overwatch-2-esp-player-tags.webp',
	},
	{
		source:
		...
		file: 'overwatch-2-wallhack-skeleton.webp',
	},
	{
		source:
		...
		file: 'overwatch-2-aimbot-sniper.webp',
	},
	{
		source:
		...
		file: 'overwatch-2-aimbot-skeleton.webp',
	},
	{
		source:
		...
		file: 'overwatch-2-esp-radar.webp',
	},
	{
		source:
		...
		file: 'overwatch-2-cheats-combat.webp',
	},
];
...
const REMOVE_PREFIXES = [
	'destiny-2-battle-royale-combat',
	'destiny-2-extract-fight',
	'overwatch-2-cheats-aimbot',
	'overwatch-2-cheats-cover',
	'overwatch-2-cheats-esp-wallhack',
	'overwatch-2-cheats-hero',
	'overwatch-2-cheats-logo',
	'overwatch-2-cheats-package',
	'destiny-2-header-art',
	'destiny-2-loadout-builder',
	'destiny-2-player-esp',
	'destiny-2-scav-run-combat',
	'destiny-2-scav-run-mode',
	'destiny-2-squad-fight',
	'destiny-2-verdansk-map',
];

async function removeOldOverwatch 2Images() {
...
async function generateResponsiveVariants() {
	const heroSource = path.join(imagesDir, 'overwatch-2-esp-player-tags.webp');
	const heroMeta = await sharp(heroSource).metadata();

	for (const width of HERO_WIDTHS) {
		if (heroMeta.width && width > heroMeta.width) continue;
		const file = `overwatch-2-esp-player-tags-${width}w.webp`;
	...
	for (const { file } of USER_SCREENSHOTS) {
		if (file === 'overwatch-2-esp-player-tags.webp') continue;
...
async function generateFavicons() {
	const logoPath = path.join(imagesDir, 'overwatch-2-cheats-logo.png');
...
await removeOldOverwatch 2Images();
