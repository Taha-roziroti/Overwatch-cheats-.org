...
export function validateBrandPayload(body) {
	...
	const logo = assetPath(b.logo ?? '/images/overwatch-2-cheats-logo.webp');
	const logoRaster = assetPath(b.logoRaster ?? '/images/overwatch-2-cheats-logo.png');
	const defaultOgImage = assetPath(b.defaultOgImage ?? '/images/overwatch-2-cheats-combat.webp');
	const heroImage = assetPath(b.heroImage ?? '/images/overwatch-2-hero-banner.webp');
