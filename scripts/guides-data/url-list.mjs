/** Provided URL list — normalized https, no trailing slash. Duplicates removed at generation time. */
export const providedUrls = [
	...
	'https://palworldcheat.org',
];

export const URL_LIST = providedUrls;
