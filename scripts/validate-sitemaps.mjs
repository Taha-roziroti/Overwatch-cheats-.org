...
const REDIRECT_ONLY_PATHS = new Set([
	'/d2-best-cheats/',
	'/overwatch-2-aimbot-hack/',
	'/overwatch-2-esp-hack/',
...
const ENGLISH_PATHS = [
	...
	'/reviews/flickbot-ctrl-player99/',
	'/reviews/setup-stormchaser07/',
	'/reviews/hero-esp-ulttrackerx/',
	'/reviews/aimbot-competitive-rankedgrind42/',
	'/reviews/wallhack-vanlifeow/',
	'/reviews/patch-update-patchdaymike/',
	'/reviews/sniper-aim-snipezonly/',
	'/faq/what-are-overwatch-2-cheats/',
	'/faq/undetected-in-2026/',
	'/faq/quick-play-competitive-arcade/',
	'/faq/esp-wallhack-aimbot/',
	'/faq/license-delivery/',
	'/faq/check-updates/',
	'/faq/contact-support/',
	'/faq/what-is-wallhack/',
	'/faq/hero-scripts-included/',
	'/faq/blizzard-anticheat-and-cheats/',
