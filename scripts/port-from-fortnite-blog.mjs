#!/usr/bin/env node
/**
 * Ports the 8 posts from ../destiny-2-blog into src/data/blog/posts.generated.ts
...
const SOURCE_DIR = join(ROOT, '..', 'destiny-2-blog', 'src', 'content', 'posts');
...
for (const file of POST_FILES) {
	...
	sources.push({
		...
		intro: post.excerpt,
		keywords: [...post.tags, 'destiny-2 intel'],
...
const file = `/* Auto-generated by scripts/port-from-destiny-2-blog.mjs — do not edit by hand. */
