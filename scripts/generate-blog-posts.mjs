		...
		sections: [
			{
				...
				paragraphs: [
					...
					`If you also run third-party tools, separate game balance from anti-cheat maintenance. After a ${EXT.battleye} or client update, check our <a href="/status/">Destiny 2 Cheats status page</a> before you blame your own aim.`,
				],
			},
			{
