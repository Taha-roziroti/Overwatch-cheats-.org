		...
		sections: [
			{
				...
				paragraphs: [
					`Shop rotations and official apparel come from ${EXT['destiny-2']}. Leaks are entertainment, not a shopping list. Many players spend hard-earned glimmer the night before a season reset, then realize they still need consumables, ammo, and a backup kit.`,
		...
		sections: [
			{
				...
				paragraphs: [
					`Start with schedules and film from ${EXT['destiny-2']} community events or trusted creators, then tag habits instead of memorizing a single zone name. Note the spawn plan, first heal, first rotate, first voluntary fight, and the key late-encounter decision.`,
		...
		sections: [
			...
			},
			{
				...
				paragraphs: [
					...
					`Timing targets help: first primary quickly, clear a cluster, grab heals, then upgrade or leave. Slot priority is usually primary, ammo, resilience mods, healing, then bonus loot. Zone names shift with ${EXT['destiny-2']} season updates — keep the geometry, not just the landmark label.`,
				],
			},
			{
		...
		sections: [
			{
				...
				paragraphs: [
					`Easy Anti-Cheat is documented at ${EXT.easy-anticheat}. It evolves. Vendors who care publish rebuild notes when ESP, radar, or aim modules need work. Overwatch 2 Cheats does that on <a href="/status/">Updates</a> and explains the workflow on <a href="/status/">Easy Anti-Cheat maintenance</a>.`,
